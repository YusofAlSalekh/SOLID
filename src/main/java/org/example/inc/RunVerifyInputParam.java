...
public class RunVerifyInputParam {
    public static void main(String[] args) {
        ...
        setupJBSE(paramsAB, "org/example/inc/VerifyInputParam", "(Lorg/example/inc/Param;)V", "verifyMethodAB");
        runJBSE(paramsAB);

        // Setup JBSE to run verifyMethodAC
        RunParameters paramsAC = new RunParameters();
        setupJBSE(paramsAC, "org/example/inc/VerifyInputParam", "(Lorg/example/inc/Param;)V", "verifyMethodAC");
        runJBSE(paramsAC);

        // Setup JBSE to run verifyMethodBC
        RunParameters paramsBC = new RunParameters();
        setupJBSE(paramsBC, "org/example/inc/VerifyInputParam", "(Lorg/example/inc/Param;)V", "verifyMethodBC");
        runJBSE(paramsBC);
